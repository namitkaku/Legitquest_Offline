...
import {    toogleTitleFilter } from "../redux/components/sc-material";
function ByTitle({
  label,
  onApplyFilter,
  list,
...
const mapStateToProps = (state) => ({
  ...
  currentFilterValues: [...state.filter.TitleArray],
});

const mapDispatchToProps = {
  setMultiFilterSelectedRedux$: setMultiFilterSelectedRedux,
  toogleBenchFilter$: toogleTitleFilter,
};
export default connect(mapStateToProps, mapDispatchToProps)(ByTitle);
