...
const actdetail = ({match}) => {
    ...
    <h5 className="d-inline font-weight-bold mb-0 mx-auto" id="secondaryTitle">{data.name}</h5>
                      <button type="button" className="btn btn-outline-dark  p-0 px-2 py-1 mr-2 text-nowrap d-flex">
                        <i className="fa fa-file-pdf mr-0 mr-md-1" data-toggle="tooltip" data-placement="left" title="" data-original-title="Download pdf"></i> 
                        <small className="d-none d-md-block"> PDF</small>
                      </button>
                  </div>
                </div>
              </div>
